...
<!-- knowledge-workshop:generated canonical-skill source=share/knowledge_workshop/templates/agent-skills/kw-propose/SKILL.md.tmpl source-sha256=8b7a36d1a96d445b0fe13e57108df61a8952188dae7c4da7e7949a02ef60d0e2 -->
...
9. 在 design 和 task planning 阶段判断是否存在 project-goal reusable knowledge gap 需要长期 `knowledge/**` 或 `specs/**` 回写。执行前记录计划 target、not-needed category 或 follow-up change，避免 acceptance 的 `review-knowledge` 临时补判断。
