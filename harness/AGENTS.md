<!-- kw-doc: {"model":"kw-doc-meta-v1","doc_id":"agents","title":"harness_1_2_0 Agent 入口","locale":"zh-CN","canonical_path":"AGENTS.md"} -->

# harness_1_2_0 Agent 入口

<!-- knowledge-workshop:managed:start template=consumer-minimal-v1 version=1.2.0 -->

## 用途

- 本目录是 `harness_1_2_0` 的 Knowledge Workshop 控制面，使用 Knowledge Workshop `1.2.0`。
